...
从高中走过来的Newbie English英语学习平台开发团队——反内卷软工小组深知高中生在填空、选择题部分的乏力，因此决定开发Newbie English英语学习平台，旨在给高中生们创造出来一个可以通过微信小程序打开，随时随地便可刷题的英语学习软件，市面上的英语学习平台针对性不强，我们使用过的一些平台都没有针对高考题目的刷题功能，因此这种英语学习小程序对高中生来说也许便捷且实用，在地铁，公交车上打开手机不再是社交软件和游戏视频，而是可以随手看两道英语真题。
...
![总体框架](D:\study\学习作业！\软件工程\总体框架.png)
...
![4.1 流程图](D:\study\学习作业！\软件工程\git\ReRoll\docs\assets\4.1 流程图.png)

#### 4.1.2 用例图

![4.1 用例图](D:\study\学习作业！\软件工程\git\ReRoll\docs\assets\4.1 用例图.png)
...
![4.2 流程图](D:\study\学习作业！\软件工程\git\ReRoll\docs\assets\4.2 流程图.png)

#### 4.2.2 用例图

![4.2 用例图](D:\study\学习作业！\软件工程\git\ReRoll\docs\assets\4.2 用例图.png)
...
只允许管理员操作，支持文本格式的题目上传，可选择题目难度与题型。系统为每种题目，提供模板供管理员填写。选项部分，管理员可以直接一次性粘贴所有选项，再由系统自动识别出每个选项，也可手动录入每一个选项。提供预览功能，让管理员确认自动识别的效果，若确认有误可手动修改。
...
该页面提供登录功能，通过用户名和密码完成验证，同时支持微信账号认证登录。登陆完成之后自动跳转题库页面，系统角色认定为用户，并且提供注册页面跳转按钮，点击后跳转到注册页面。

##### 5.1.2.3  注册页面

该页面提供账号注册功能。 注册时需要收集的信息有：用户名或电子邮箱地址、密码。后注册完毕后跳转登录界面，仍需要重新登陆。
